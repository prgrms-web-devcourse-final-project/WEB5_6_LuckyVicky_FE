...
export default function page() {
  return (
    <main className="px-[125px] py-[80px] max-w-[min(1200px,calc(100vw-250px))] mx-auto">
        <h1 className="font-bold text-2xl px-[55px]">이용약관</h1>

        <div className="px-[55px]">
            <h2 className="font-bold py-[20px]">morimori 서비스 이용약관</h2>

            {/* 제1조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제1조(목적)</h2>
      <p>
        이 약관은 모리모리 회사(전자상거래 사업자)가 운영하는 모리모리 사이버 몰(이하
      ...
      {/* 제2조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제2조(정의)</h2>
      <p>
        ① “몰” 이란 모리모리 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게
        제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한
      ...
      {/* 제3조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제3조 (약관등의 명시와 설명 및 개정)</h2>
      <p>
        ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을
        처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소,
        사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록
        00 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가
        연결화면을 통하여 볼 수 있도록 할 수 있습니다.
      </p>
      <p>
        ② “몰은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중 청약철회,
        배송책임, 환불조건 등과 같은 중요한 내용을 이용자가 이해할 수 있도록 별도의
      ...
      <p>
        ...
        제3항에 의한 개정약관의 공지기간내에 ‘몰“에 송신하여 ”몰“의 동의를 받은 경우에는
        개정약관 조항이 적용됩니다.
      </p>
      <p>
        ⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는
        전자상거래등에서의소비자보호에관한법률, 약관의규제등에관한법률,
        공정거래위원회가 정하는 전자상거래등에서의소비자보호지침 및 관계법령 또는 상관례에
        따릅니다.
      </p>

      {/* 제4조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제4조(서비스의 제공 및 변경)</h2>
      ...
      <p>
        ...
        또는 용역의 내용 및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에
        즉시 공지합니다.
      </p>
      <p>
      ...
      {/* 제5조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제5조(서비스의 중단)</h2>
      <p>
      ...
      <p>
        ...
        경우에는 “몰”은 제8조에 정한 방법으로 이용자에게 통지하고 당초 “몰”에서 제시한
        조건에 따라 소비자에게 보상합니다. 다만, “몰”이 보상기준 등을 고지하지 아니한
        경우에는 이용자들의 마일리지 또는 적립금 등을 “몰”에서 통용되는 통화가치에 상응하는
        현물 또는 현금으로 이용자에게 지급합니다.
      </p>

      {/* 제6조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제6조(회원가입)</h2>
      <p>
      ...
      <ol className="list-decimal pl-6 space-y-1">
        <li>
          가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우,
      ...
      {/* 제7조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제7조(회원 탈퇴 및 자격 상실 등)</h2>
      ...
      <p>③ “몰”이 회원 자격을 제한/정지 시킨후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “몰”은 회원자격을 상실시킬 수 있습니다.</p>
      <p>④ “몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.</p>

      {/* 제8조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제8조(회원에 대한 통지)</h2>
      <p>① “몰”이 회원에 대한 통지를 하는 경우, 회원이 “몰”과 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.</p>
      <p>
        ② “몰”은 불특정다수 회원에 대한 통지의 경우 1주일이상 “몰” 게시판에 게시함으로서 개별
        통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는
        사항에 대하여는 개별통지를 합니다.
      </p>

      {/* 제9조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제9조(구매신청)</h2>
      <p>
        “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은
        이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단,
      ...
      {/* 제10조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제10조 (계약의 성립)</h2>
      <p>
      ...
      {/* 제11조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제11조(지급방법)</h2>
      <p>
        “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각호의 방법중 가용한 방법으로
      ...
      {/* 캐시/지갑 조항 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의2조(캐시 및 지갑의 정의)</h2>
      <p>① “캐시”라 함은 “몰”에서 재화 등을 구매하기 위하여 회원이 충전하거나 “몰”이 부여하는 서비스 전용 선불수단을 말합니다.</p>
      <p>② “보너스 캐시”라 함은 이벤트·프로모션·보상 등으로 무상 부여되는 캐시를 말하며 현금환급 대상이 아닙니다. MVP 기간 동안에는 제공되지 않습니다.</p>
      <p>③ “현금성 캐시”라 함은 회원이 유상으로 충전한 캐시를 말합니다. 현금환급 기능은 제공하지 않습니다.</p>
      <p>④ “작가지갑(정산캐시)”라 함은 판매대금 정산을 위해 작가회원에게 적립되는 지갑을 말합니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의3조(캐시의 충전·사용·차감 순서)</h2>
      <p>① 회원은 “몰”이 정한 방법(각종 페이 등)으로 캐시를 충전할 수 있습니다.</p>
      <p>② 캐시 사용 시 차감 순서는 보너스 캐시 → 현금성 캐시 순으로 합니다(별도 고지 시 달리 정할 수 있음).</p>
      <p>③ 캐시는 “몰” 내 재화·용역 결제에 한하여 사용할 수 있으며, 타인에게 양도·대여·담보 제공할 수 없습니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의4조(캐시의 환급·소멸)</h2>
      <p>① 회원은 캐시를 현금으로 환급받을 수 없습니다.</p>
      <p>② 회원이 계정을 탈퇴하는 경우 보유 캐시는 전액 소멸합니다. (소멸 예정 금액은 탈퇴 화면에 고지합니다.)</p>
      <p>③ 캐시 충전 후 결제취소·환불이 발생하는 때에는 결제 취소 범위 내에서 캐시로 재적립하거나, 최초 결제수단으로의 환불 등 “몰”이 정한 기준에 따릅니다.</p>
      <p>④ “몰”은 장기간 미이용 계정의 캐시 소멸 기준(예: 최종 사용일로부터 12개월)을 서비스 화면에 사전 고지할 수 있습니다. 보너스 캐시는 부여 시 고지된 유효기간 경과 시 자동 소멸됩니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의5조(오류 정정 및 제한)</h2>
      <p>① 시스템 오류, 결제사 취소·차지백, 부정 사용 등이 발생한 경우 “몰”은 해당 금액을 <strong>정정(가감)</strong>할 수 있으며, 필요한 경우 일시적으로 캐시 사용을 제한할 수 있습니다.</p>
      <p>② 회원의 귀책 사유로 인한 부정 충전·부정 사용이 확인되면 “몰”은 캐시 회수, 거래 취소, 회원자격 제한 등 필요한 조치를 할 수 있습니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의6조(작가지갑(정산캐시))</h2>
      <p>① 작가회원의 판매대금은 정산 주기(예: 매월/매주) 및 검수·환불 보류 기간 경과 후 작가지갑에 적립됩니다.</p>
      <p>② 작가회원은 본인 확인(KYC) 및 세무 정보 등록 후 “몰”이 정한 절차에 따라 현금 출금을 신청할 수 있습니다. 출금 수수료·최소/최대 한도는 화면에 고지합니다.</p>
      <p>③ 정산 대상 금액은 판매금액에서 수수료, PG 수수료, 환불·차지백·분쟁 보류액 등을 차감한 금액으로 산정합니다. 보류액은 사유 해소 시점에 정산됩니다.</p>
      <p>④ 허위 등록·저작권 침해 등으로 거래가 취소되는 경우, 이미 지급된 금액은 상계 또는 환수될 수 있습니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의7조(탈퇴 및 계정 정지 시 처리)</h2>
      <p>① 회원이 탈퇴를 신청하는 경우, 미해결 주문·분쟁·환불이 있는 때에는 해당 사유가 해소될 때까지 탈퇴가 보류될 수 있습니다.</p>
      <p>② 탈퇴가 확정되면 제11의4조에 따라 캐시는 소멸되고, 개인정보는 법령 및 개인정보처리방침에 따라 파기 또는 분리보관합니다.</p>
      <p>③ 작가회원의 경우, 미정산 금액은 본인 확인 완료 및 보류 사유 해소 후 출금 절차에 따릅니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제11의8조(약관 우선·변경 고지)</h2>
      <p>① 캐시·작가지갑 운영정책의 세부 사항(충전/사용/수수료/한도/유효기간 등)은 서비스 화면의 운영정책으로 정할 수 있으며, 본 약관과 상충하는 경우 본 약관을 우선합니다.</p>
      <p>② “몰”은 캐시·작가지갑 정책을 변경하는 때에는 적용일자 및 주요 변경 내용을 7일(이용자에게 불리한 경우 30일) 이전에 공지합니다.</p>

      {/* 제12조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제12조(수신확인통지/구매신청 변경 및 취소)</h2>
      <p>① “몰”은 이용자의 구매신청이 있는 경우 이용자에게 수신확인통지를 합니다.</p>
      <p>
        ② 수신확인통지를 받은 이용자는 의사표시의 불일치등이 있는 경우에는 수신확인통지를 받은
        후 즉시 구매신청 변경 및 취소를 요청할 수 있고 “몰”은 배송전에 이용자의 요청이 있는
        경우에는 지체없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는
        제15조의 청약철회 등에 관한 규정에 따릅니다.
      </p>

      {/* 제13조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제13조(재화등의 공급)</h2>
      <p>
        ① “몰”은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을
        한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를
        취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부
        또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화등의
      ...
      {/* 제14조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제14조(환급)</h2>
      <p>
        “몰”은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는
        지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은
        날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.
      </p>

      {/* 제15조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제15조(청약철회 등)</h2>
      ...
      <p>
        ④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화등의 내용이 표시·광고 내용과 다르거나
        계약내용과 다르게 이행된 때에는 당해 재화등을 공급받은 날부터 3월이내, 그 사실을 안 날
        또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.
      </p>

      {/* 제16조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제16조(청약철회 등의 효과)</h2>
      ...
      {/* 제17조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제17조(개인정보보호)</h2>
      <p>① “몰”은 이용자의 정보수집시 구매계약 이행에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.</p>
      <ol className="list-decimal pl-6 space-y-1">
        <li>성명</li><li>주소</li><li>전화번호</li><li>희망ID(회원의 경우)</li><li>비밀번호(회원의 경우)</li><li>전자우편주소(또는 이동전화번호)</li>
      </ol>
      ...
      {/* 제18조~제24조 */}
      <h2 className="mt-10 mb-3 text-xl font-semibold">제18조(“몰“의 의무)</h2>
      ...
      <h2 className="mt-10 mb-3 text-xl font-semibold">제19조(회원의 ID 및 비밀번호에 대한 의무)</h2>
      ...
      <h2 className="mt-10 mb-3 text-xl font-semibold">제20조(이용자의 의무)</h2>
      <ol className="list-decimal pl-6 space-y-1">
      ...
      <h2 className="mt-10 mb-3 text-xl font-semibold">제21조(연결“몰”과 피연결“몰” 간의 관계)</h2>
      ...
      <h2 className="mt-10 mb-3 text-xl font-semibold">제22조(저작권의 귀속 및 이용제한)</h2>
      ...
      <h2 className="mt-10 mb-3 text-xl font-semibold">제23조(분쟁해결)</h2>
      <p>① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 설치?운영합니다.</p>
      <p>② “몰”은 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다.</p>
      <p>③“몰”과 이용자간에 발생한 전자상거래 분쟁과 관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시·도지사가 의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.</p>

      <h2 className="mt-10 mb-3 text-xl font-semibold">제24조(재판권 및 준거법)</h2>
      ...
      <p>부 칙(시행일) 이 약관은 2025년 9월 20일부터 시행합니다.</p>
      </div>
    </main>
  )
}